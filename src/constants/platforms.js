...
export const FILTER_EXCLUDED_PLATFORMS = [];
...
const PLATFORM_FILTER_COLORS = {
  ...
  "google(adspower)": "bg-lime-100 text-lime-700 border border-lime-200",
  ...
  junkie: "bg-violet-100 text-violet-700 border border-violet-200",
  pushnami: "bg-teal-100 text-teal-700 border border-teal-200",
};
